...
for train_idx, test_idx in kf.split(proddf):
    ...
    # Products are predicted to be awesome if the average of review predictions is over 4.5
    prediction_is_awesome = lambda x: 1 if np.mean(x) > 4.95 else 0
