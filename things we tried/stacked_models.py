...
# Base estimators used in stacking
estimators = [('rf', RandomForestClassifier(n_estimators=100, random_state = 50)),
                ('ab', AdaBoostClassifier(n_estimators=100, random_state = 50)),
